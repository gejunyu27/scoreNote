...
- (void)homeCellEditRealNum:(RecordModel *)record;      //修改实际期数
- (void)homeCellEditScore:(RecordModel *)record;        //修改买法
- (void)homeCellBuy:(RecordModel *)record;              //立即购买
...
- (void)homeCellBuyWin:(RecordModel *)record;           //红单
